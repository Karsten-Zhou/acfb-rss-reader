...
- **AI summaries**: optional per-article summaries generated by Workers AI,
  toggled from the Settings panel (disabled by default; model picker included).
  Versioned prompts, a registry of free-tier models, and KV caching keyed by
  content + language.
